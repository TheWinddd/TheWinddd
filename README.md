...
expertise:
  pharma : Market Research · Quality Control · GMP/GDP · Regulatory
  tech   : AI Agents · Full-stack (Next.js) · Data Pipeline · RAG

now_building:
  - AI-powered tools for pharmaceutical workflows
  - Market intelligence automation for pharma industry

fun     : 🎹 Piano · ☕ Coffee · 📚 Always learning
```
...
|---|---|---|
| **🔵 Market Intelligence Pipeline** | Tự động hoá thu thập & phân tích dữ liệu thị trường Dược từ scraping đến insight | `Data Pipeline` `Pharma` |
| **🤖 BCKT AI – Portfolio Assistant** | AI Agent tự động lập báo cáo khảo sát thị trường, phân tích sản phẩm & đối thủ | `AI Agents` `RAG` |
| **🎙️ Voice Analytics & QA Scoring** | Chuyển đổi audio CSKH → transcript có timestamp + chấm điểm chất lượng tự động | `AI` `Customer Experience` |
| **📍 MedRep CRM + Territory Manager** | Tìm lead nhà thuốc từ Google Maps, quản lý địa bàn & KPI cho trình dược viên | `CRM` `Pharma Sales` |
| **📊 Pharma Job Market Dashboard** | Phân tích xu hướng tuyển dụng, mức lương & kỹ năng ngành Dược Việt Nam | `Market Research` `Viz` |
| **🔗 LinkLM – Research Capture** | Chrome extension lưu & tóm tắt trang web → tự động đẩy vào NotebookLM | `AI Agents` `Productivity` |

> 🔗 Xem toàn bộ 12 dự án tại **[vanquanbui.vercel.app](https://vanquanbui.vercel.app/)**
